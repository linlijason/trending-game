...
public class DictUtilsTest {
    ...
    public void ttt() throws Exception {
        ...
        String md5 = Md5Utils.hash("111111");
        String password = bCryptPasswordEncoder.encode(md5);
        System.out.println(bCryptPasswordEncoder.matches(md5, password));

        System.out.println(password);
        System.out.println(URLEncoder.encode(password, "utf-8"));
        System.out.println("----------");
        System.out.println(UidHashUtils.hashId(13L));
        Pbkdf2PasswordEncoder pbkdf2PasswordEncoder = new Pbkdf2PasswordEncoder();
        password = pbkdf2PasswordEncoder.encode(UidHashUtils.hashId(13L));
        System.out.println(pbkdf2PasswordEncoder.matches(UidHashUtils.hashId(13L), password));
        System.out.println(password);
    ...
    @Test
    public void ttt2() {
        System.out.println(UidHashUtils.hashId(508L));
        //websocket_ht_b6b6001a3a4dde85cdcc5c1abf6ee4db60
        int uid = 100;
        int ts = 1641271726;

        String tsStr = new String(Base62.createInstance().encode(IntegerUtils.byteArrayFromInt(ts)));
        System.out.println(tsStr);
        byte[] bs = Base62.createInstance().decode(tsStr.getBytes());
        System.out.println(IntegerUtils.intFromByteArray(bs, 0));
    ...
    public void isDigit(){
        ...
        System.out.println(pattern.matcher("2.0").matches());
