...
import com.bistro.common.core.page.PageDomain;
import com.bistro.common.core.page.TableDataInfo;
import com.bistro.common.core.page.TableSupport;
...
import com.bistro.common.utils.sql.SqlUtil;
...
public class BaseController
{
    ...
    public ApiUser getApiUser(HttpHeaders headers) {
        String id = headers.get("id").get(0);
        String sid = headers.get("sid").get(0);
//        List<String> langs = headers.get("lang");
        String lang = null;
//        if (langs != null) {
//            lang = headers.get("lang").get(0);
//        } else {
//            lang = headers.getAcceptLanguage().get(0).toString();
//        }
        ...
        if (!SidUtils.check(id, sid)) {
            ...
            return new ApiUser(UidHashUtils.uid(id), lang);
        }
    }
}
