package com.bistro.framework.web.exception;
...
import com.bistro.common.exception.DemoModeException;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult handleApiException(ApiException e) {
        log.error(e.getMessage(), e);
        String message = e.getMessage();
        return AjaxResult.error(e.getCode(), message);
    }

    @ExceptionHandler(SeamlessException.class)
    public  ResponseEntity<String>   handleSeamlessException(SeamlessException e) {
        log.error(e.getMessage(), e);
        String message = e.getMessage();

        MySeamlessResult result = MySeamlessResult.error(e.getErrorCode(), message);
        ResponseEntity<String> body = ResponseEntity.status(result.getHttpCode())
